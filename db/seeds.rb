...
item1 = Item.create(
                    ...
                    price:        9.35,
                    status:       1,
                    image:        open("lib/seed_images/1.jpg")
                    )
...
item2 = Item.create(title:       "Coffee creamy dreams",
                    ...
                    price:       9.35,
                    status:      1,
                    image:       open("lib/seed_images/2.jpg")
                    )
...
item3 = Item.create(title:       "Milky chocolate lova'",
                    ...
                    price:       10.75,
                    status:      1,
                    image:       open("lib/seed_images/3.jpg")
                    )
...
item4 = Item.create(title:       "Margerita Lima lickin'",
                    ...
                    price:       10.75,
                    status:      1,
                    image:        open("lib/seed_images/4.jpg")
                    )
...
item5 = Item.create(title:       "Strawberry passionate",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/5.jpg")
                    )
...
item6 = Item.create(title:       "Malbec makeout",
                    ...
                    price:       8.29,
                    status:      1,
                    image:        open("lib/seed_images/6.png")
                    )
...
item7 = Item.create(title:       "Minty mythos",
                    ...
                    price:       8.29,
                    status:      1,
                    image:        open("lib/seed_images/7.jpg")
                    )
...
item8 = Item.create(title:       "Cherry cheery cheeks",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/8.jpg")
                    )
...
item9 = Item.create(title:       "Blackberry night",
                    ...
                    price:       10.75,
                    status:      1,
                    image:        open("lib/seed_images/9.jpg")
                    )
...
item10 = Item.create(title:      "Peachy pucker up",
                    ...
                    price:       8.29,
                    status:      1,
                    image:        open("lib/seed_images/10.jpg")
                    )
...
item11 = Item.create(title:      "Lemon Purrrrang...",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/11.jpg")
                    )
...
item12 = Item.create(title:      "Tropical fling",
                    ...
                    price:       10.75,
                    status:      1,
                    image:        open("lib/seed_images/12.jpg")
                    )
...
item13 = Item.create(title:      "Awesome sauce",
                    ...
                    price:       11.49,
                    status:      1,
                    image:        open("lib/seed_images/13.jpg")
                    )
...
item14 = Item.create(title:      "Butter my baby",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/14.jpg")
                    )
...
item15 = Item.create(title:      "Lil' Ginger tart",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/15.jpg")
                    )
...
item16 = Item.create(title:      "Take me home tonight",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/16.jpg")
                    )
...
item17 = Item.create(title:      "Aztec lover",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/17.jpg")
                    )
...
item18 = Item.create(title:      "Minty freshness",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/18.jpg")
                    )
...
item19 = Item.create(title:      "The temtress",
                    ...
                    price:       10.75,
                    status:      1,
                    image:        open("lib/seed_images/19.jpg")
                    )
...
item20 = Item.create(title:      "Irish lass",
                    ...
                    price:       8.25,
                    status:      1,
                    image:        open("lib/seed_images/20.jpg")
                    )
...
item21 = Item.create(title:      "White wine sherbert",
                    ...
                    price:       8.25,
                    status:      1,
                    image:        open("lib/seed_images/21.jpg")
                    )
...
item22 = Item.create(title:      "Tortuga nights",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/22.jpg")
                    )
...
item23 = Item.create(title:      "Muff'n crush",
                    ...
                    price:       9.35,
                    status:      1,
                    image:        open("lib/seed_images/23.jpg")
                    )
