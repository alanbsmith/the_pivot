...
if (s_Host.indexOf("tv.adobe") != -1) {
    if (s_Host.indexOf("dev.") != -1 ||
        ...
        s_adobe_account = "adbadobenonacdcqa";
    } else {
        s_adobe_account = "adbadobenonacdcprod";
    }
} else if (s_Host.indexOf("adobe.com") != -1) {
    if (s_Host.indexOf("sqa.aedash") != -1 || s_Host.indexOf("stage.aedash") != -1){
        s_adobe_account = "adbccentdashqa";
        }
    else if (s_Host.indexOf("aedash.adobe") != -1){
         s_adobe_account = "adbccentdashprod";
        }
    else if ((s_Host.indexOf("services.adobe.com") != -1) ||
        (s_Host.indexOf("localhost.corp.adobe.com") != -1)) {
        s_adobe_account = "adbadobenonacdcqa";
    } else if (s_Host.indexOf(".dev.adobe.") != -1 ||
        ...
        s_adobe_account = "adbadobenonacdcprod,adbadobedigitalriverprod";
    } else if (s_Host.indexOf("lightroom.adobe.com") != -1) {
        s_adobe_account = "adbadobenonacdcprod";
    } else if (s_Host.indexOf("help.adobe.com") != -1 ||
        s_Host.indexOf("helpx.adobe.com") != -1 ||
      	s_Host.indexOf("forums.adobe.com") != -1 ||
        s_Host.indexOf("helpx-internal.corp.adobe.com") != -1) {
        s_adobe_account = "adbadobenonacdcqa";
    } else {
        s_adobe_account = "adbadobenonacdcprod";
    }
} else if (s_Host.indexOf("portal-stage.adobe.io") != -1) {
    s_adobe_account = "adbadobenonacdcqa";
    ...
    s_adobe_account = "adbadobenonacdcprod,adbbehanceprod";
} else if (s_Host.indexOf("phonegap.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("douwriteright.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("net.s2stagehance") != -1) {
    s_adobe_account = "adbadobenonacdcqa,adbbehanceqa";
} else if (s_Host.indexOf("voice-stage.dmg.suitedemand") != -1) {
    s_adobe_account = "adbadobenonacdcqa";
} else if (s_Host.indexOf("event.hummingimc.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("learnacrobat-xi.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("talent.adweek.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("gallery.wacom.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("canvas.pantone.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("studentshow.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("portfolios.aiga.org") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("ndagallery.cooperhewitt.org") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if ((s_Host.indexOf("getacrobat-xi.com") != -1) ||
    (s_Host.indexOf("learnacrobat-xi.com") != -1)) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("adobe-gakuwari.jp") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("ccps.ihvweb8.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("citrix1.editinps.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("mfdemo.editinps.com") != -1) {
    s_adobe_account = "adbadobenonacdcprod";
} else if (s_Host.indexOf("ponysaurus.com") != -1) {
    s_adobe_account = "adbadobenonacdcqa";
} else if (s_Host.indexOf("creativecloud.adobeevents.com") != -1) {
  	s_adobe_account = "adbadobenonacdcprod";
}
// Behance ProSite domain names
else if (
    // Served Sites
    (s_Host.indexOf("muaserved.com") != -1) ||
    (s_Host.indexOf("toydesignserved.com") != -1) ||    
    (s_Host.indexOf("editorialdesignserved.co") != -1) ||
    (s_Host.indexOf("digitalartserved.com") != -1) ||
    (s_Host.indexOf("advertisingserved.com") != -1) ||
    (s_Host.indexOf("artserved.com") != -1) ||
    (s_Host.indexOf("furnitureserved.com") != -1) ||
    (s_Host.indexOf("packagingserved.com") != -1) ||
    (s_Host.indexOf("industrialdesignserved.com") != -1) ||
    (s_Host.indexOf("drawingserved.com") != -1) ||
    (s_Host.indexOf("appdesignserved.co") != -1) ||
    (s_Host.indexOf("motionserved.com") != -1) ||
    (s_Host.indexOf("illustrationserved.com") != -1) ||
    (s_Host.indexOf("webdesignserved.com") != -1) ||
    (s_Host.indexOf("interiordesignserved.com") != -1) ||
    (s_Host.indexOf("architectureserved.com") != -1) ||
    (s_Host.indexOf("typographyserved.com") != -1) ||
    (s_Host.indexOf("brandingserved.com") != -1) ||
    (s_Host.indexOf("characterdesignserved.com") != -1) ||
    (s_Host.indexOf("fashionserved.com") != -1) ||
    (s_Host.indexOf("id-mag.com") != -1) ||
    (s_Host.indexOf("inspiration.is") != -1) ||
    (s_Host.indexOf("thedigitalage.com") != -1) ||
    // Schools
    (s_Host.indexOf("portfolios.saic.edu") != -1) ||
    (s_Host.indexOf("portfolios.moore.edu") != -1) ||
    (s_Host.indexOf("portfolios.mica.edu") != -1) ||
    (s_Host.indexOf("portfolios.fitnyc.edu") != -1) ||
    (s_Host.indexOf("portfolios.artinstitutes.edu") != -1) ||
    (s_Host.indexOf("portfolios.uniandes.edu.co") != -1) ||
    (s_Host.indexOf("portfolios.ringlingcollege.me") != -1) ||
    (s_Host.indexOf("portfolios.corcoran.edu") != -1) ||
    (s_Host.indexOf("portfolios.pratt.edu") != -1) ||
    (s_Host.indexOf("portfolios.sva.edu") != -1) ||
    (s_Host.indexOf("network.artcenter.edu") != -1) ||
    (s_Host.indexOf("portfolios.risd.edu") != -1) ||
    (s_Host.indexOf("portfolios.collegeforcreativestudies.edu") != -1) ||
    (s_Host.indexOf("portfolios.scad.edu") != -1) ||
    (s_Host.indexOf("designportfolios.philau.edu") != -1) ||
    // Organizations
    (s_Host.indexOf("gallery.wacom.com") != -1) ||
    (s_Host.indexOf("ndagallery.cooperhewitt.org") != -1) ||
    (s_Host.indexOf("studentshow.com") != -1) ||
    (s_Host.indexOf("canvas.pantone.com") != -1) ||
    (s_Host.indexOf("talent.adweek.com") != -1) ||
    (s_Host.indexOf("portfolios.aiga.org") != -1)
) {
    s_adobe_account = "adbadobenonacdcprod";
} 
else if (s_Host.indexOf("photographyserved.com") != -1){
   s_adobe_account = "adbadobenonacdcprod,adbbehanceprod";
}
...
if(!s_adobe.__ccucr)
{
	...
	function c_r(k)
	{
		...
		v=(v)?v:'';if(m>0&&m!=e)if(parseInt(c.substring(m+1,e<0?c.length:e))<d.getTime())
...
if (s_adobe.c_r("omniture_optout")!=1 && 
    s_URL.indexOf("adoberevel.com")==-1 && 
    s_URL.indexOf("bendersaurus.com")==-1 && 
    s_URL.indexOf("echosign.com")==-1 && 
    s_URL.indexOf("photoshop.com")==-1 && 
    s_URL.indexOf("ponysaurus.com")==-1 && 
    s_URL.indexOf("pxfuture.com")==-1 && 
    s_URL.indexOf("pxnext.com")==-1 &&
    s_URL.indexOf("behance.net")==-1 &&
    s_URL.indexOf("net.s2stagehance.com")==-1 &&
    s_URL.indexOf("symposium.adobe.com")==-1 &&
    s_URL.indexOf("eiseverywhere.com")==-1 &&
    s_URL.indexOf("adobedigimktgsymp.com.au")==-1 &&
    s_URL.indexOf("adobedigimktgsymp.com.sg")==-1 &&
    s_URL.indexOf("gpjreg.com.au")==-1) {
