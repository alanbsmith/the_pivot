require 'rails_helper'
  ...
  describe "items/index", type: :view do
    before(:each) do
      assign(:items, [Item.create(title:"Chocolate yummy yumm", description: "Chocolate so good you'll wanna slap yo mama", price: 400, image: "icecreamslug.com", status: "active"),
